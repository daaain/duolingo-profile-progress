...
class TestConfiguration:
    ...
    def test_load_config_from_env(self, test_config):
        ...
        assert test_config['email_settings']['send_weekly'] == True
...
class TestDuolingoIntegration:
    ...
    def test_get_user_progress_error(self, mock_duolingo):
        ...
        assert progress['profile_public'] == False
...
class TestDataStorage:
    ...
    def test_history_deduplication(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            test_results = {
                "TestUser": {"username": "test", "streak": 5}
            }
...
class TestReportGeneration:
    ...
    def test_generate_leaderboard(self):
        ...
        results = {
            "User1": {"streak": 5, "weekly_xp": 100, "total_xp": 1000, "total_languages_xp": 500},
            "User2": {"streak": 10, "weekly_xp": 200, "total_xp": 2000, "total_languages_xp": 1000},
            "User3": {"streak": 3, "weekly_xp": 50, "total_xp": 500, "total_languages_xp": 250},
