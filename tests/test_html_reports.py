...
from src.html_report_generator import generate_daily_html_report, generate_weekly_html_report
...
class TestHtmlReportGeneration:
    ...
    def test_report_generator_wrapper_functions(self, sample_results, sample_goals):
        ...
        with patch('src.html_report_generator.generate_daily_html_report') as mock_daily:
        ...
        with patch('src.html_report_generator.generate_weekly_html_report') as mock_weekly:
...
class TestHtmlTemplates:
    ...
    def test_daily_template_contains_required_elements(self):
        ...
        required_placeholders = [
            "{lang}", "{title}", "{header}", "{subtitle}", "{date}",
            "{standings_title}", "{leaderboard_items}", "{streak_alerts_title}",
            "{streak_alerts}", "{footer_message}"
        ]
    ...
    def test_weekly_template_contains_required_elements(self):
        ...
        required_placeholders = [
            "{lang}", "{title}", "{header}", "{subtitle}",
            "{week_ending}", "{generated_date}", "{family_leaderboard_title}",
            "{leaderboard_items}", "{detailed_progress_title}", "{member_details}",
            "{goals_title}", "{goals_list}", "{keep_up_message}", "{footer_message}"
        ]
...
class TestDateFormatting:
    ...
    def test_date_formatting_english(self, mock_datetime):
        ...
        with patch('src.html_report_generator.get_i18n') as mock_i18n:
            ...
            results = {"Alice": {"username": "alice", "streak": 5, "weekly_xp": 100, "total_xp": 1000}}
